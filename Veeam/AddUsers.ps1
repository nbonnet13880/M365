...
.DESCRIPTION
    ...
    is $True, the item is backup ed. The last line of the script permit to create the backup jon on Veeam.
.EXAMPLE
    Before to run the script, the CmdLets for Veeam for M365 must be installed.
.NOTES
